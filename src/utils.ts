  ...
  private static expandIPv6(ip: string): string | null {
    try {
      ...
      if (ip.includes("::")) {
        ...
        const expandedParts = [...leftParts, ...Array(missingParts).fill("0000"), ...rightParts];
